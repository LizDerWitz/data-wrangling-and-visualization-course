...
#is a complete output. One line to report the model, and one to describe it 
...
#helps you to understand how specified is the value, visualization helps 

#if you want to remove a column (t for ex.) -> you have to understand what it is -> view -> select 
#often converting to data.frame helps 
...
#to make single correlation tests
...
#the levels of the random effect should be randomly distributed, they would be red
