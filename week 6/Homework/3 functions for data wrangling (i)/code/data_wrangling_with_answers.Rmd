...
# | works as or 
#str_detect should be more generic as "=="
```
...
#%>% handles more expections, runs slower 
...
```{r}
#?clean_names -> everything lower cases, "normalizes" the writing
...
# 1-7 are technically "integer" 
# ! to not keep them as characters, as vectors to be able to make Math
